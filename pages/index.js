  ...
  return (
    <div>
      <Head>
        ...
        <meta property="og:title" content="Loyal Dog Dumped At Shelter" />
        <meta property="og:type" content="articals" />
        <meta property="og:url" content="https://animal-articals.vercel.app" />
        <meta
          property="og:image"
          content="https://www.infoanimalscare.com/wp-content/uploads/2022/10/aa1-780x470-1.png"
        />
      ...
      <div class="w3-content" style={{ maxWidth: "1400px" }}>
        <header class="w3-container w3-center w3-padding-32">
          ...
          <p>
            Welcome to the blog of <span class="w3-tag">infoanimalscare</span>
          </p>
        </header>
        ...
        <div class="w3-row">
          <div class="w3-col l8 s12">
            <div class="w3-card-4 w3-margin w3-white">
              <img
                src="https://www.infoanimalscare.com/wp-content/uploads/2022/10/aa1-780x470-1.png"
                alt="Nature"
                style={{ width: "100%" }}
              />
            ...
            <div class="w3-card-4 w3-margin w3-white">
              <img
                src="https://lolitopia.com/wp-content/uploads/2021/07/2-19.jpeg"
                alt="Norway"
                style={{ width: "100%" }}
              />
              <div class="w3-container">
          ...
          <div class="w3-col l4">
            <div class="w3-card w3-margin w3-margin-top">
              <img
                src="https://lolitopia.com/wp-content/uploads/2021/07/4-12.jpeg"
                style={{ width: "100%" }}
              />
            ...
            <div class="w3-card w3-margin">
              ...
              <ul class="w3-ul w3-hoverable w3-white">
                <li class="w3-padding-16">
                  <img
                    src="https://lolitopia.com/wp-content/uploads/2021/07/6-12.jpeg"
                    alt="Image"
                ...
                <li class="w3-padding-16">
                  <img
                    src="https://lolitopia.com/wp-content/uploads/2021/07/7-11.jpeg"
                    alt="Image"
                    class="w3-left w3-margin-right"
                    style={{ width: "50px" }}
                  />
